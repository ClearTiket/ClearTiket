...
public class PaymentController {
     ...
     */
    @PostMapping("/checkout") // 👈 명세서 규칙(소문자 스네이크 케이스)에 맞춰 추가!
     ...
     */
    @PostMapping("/webhook") // 👈 레몬스퀴지 서버가 신호를 보낼 주소 뚫기!
    ...
    /**
     * 신규 결제 요청 처리 및 승인
     * @param paymentRequestDto 결제 요청 정보 데이터
     * @return 승인 완료된 결제 영수증 객체
     */
    @PostMapping
    ...
    public ResponseEntity<PaymentResponseDto> getPamentById(
